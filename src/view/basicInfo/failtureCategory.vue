...
<template>
  <div class="container-box">
    <div class="container-header">
      <h2>{{$t('layoutNav.failtureCategoryManage')}}</h2>
...
<script>
  export default {
    ...
    methods: {
      getList () {
        ...
        _vm.$http.getPage({
          ...
          success: function(res){
            ...
            if(_vm.langRouterKey !== 'failtureCategory') {
              _vm.data = _data;
            } else {
      ...
      add () {
        this.modalTit = this.$t('failtureCategory.modalTit1');
        this.$refs['formValidate'].resetFields();
        this.seen = false;
        this.modalEdit = true;
      },
      edit (data) {
        this.modalTit = this.$t('failtureCategory.modalTit2');
        this.$refs['formValidate'].resetFields();
      ...
      remove (data) {
        ...
        _vm.$Modal.confirm({
          ...
          content: `<p>${_vm.$t('failtureCategory.msg1')}</p>
          <p>${_vm.$t('failtureCategory.msg2')}</p>
