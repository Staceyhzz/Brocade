...
<template>
  <div class="container-box">
    <div class="container-header">
      <h2>{{$t('layoutNav.symptomManage')}}</h2>
...
<script>
  export default {
    ...
    methods: {
      ...
      add () {
        this.modalTit = this.$t('symptom.modalTit1');
        this.$refs['formValidate'].resetFields();
        this.seen = false;
        this.modalEdit = true;
      },
      edit (data) {
        this.modalTit = this.$t('symptom.modalTit2');
        this.$refs['formValidate'].resetFields();
      ...
      remove (data) {
        ...
        _vm.$Modal.confirm({
          ...
          content: `<p>${_vm.$t('symptom.msg1')}</p>
          <p>${_vm.$t('symptom.msg2')}</p>
