...
<template>
  <div class="container-box">
    <div class="container-header">
      <h2>{{$t('layoutNav.positionManage')}}</h2>
...
<script>
  export default {
    ...
    methods: {
      ...
      add () {
        this.modalTit = this.$t('position.modalTit1');
        this.$refs['formValidate'].resetFields();
        this.seen = false
        this.modalEdit = true
      },
      edit (data) {
        this.modalTit = this.$t('position.modalTit2');
        this.$refs['formValidate'].resetFields();
      ...
      remove (data) {
        ...
        _vm.$Modal.confirm({
          ...
          content: `<p>${_vm.$t('position.msg1')}</p>
          <p>${_vm.$t('position.msg2')}</p>
