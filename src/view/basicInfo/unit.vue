...
<script>
  export default {
    ...
    methods: {
      ...
      add () {
        this.modalTit = this.$t('unit.modalTit1');
        this.$refs['formValidate'].resetFields();
        this.modalEdit = true;
        this.seen = false;
      },
      edit (data) {
        this.modalTit = this.$t('unit.modalTit2');
        this.$refs['formValidate'].resetFields();
