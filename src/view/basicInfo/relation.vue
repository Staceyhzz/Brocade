...
<template>
  <div class="container-box" ref="containerBox">
    <div class="container-header">
      <h2>{{$t('layoutNav.relationManage')}}</h2>
...
<script>
  export default {
    ...
    methods: {
      ...
      add () {
        this.modalTit = this.$t('relation.modalTit1');
        this.$refs['formValidate'].resetFields();
        this.seen = false
        this.modalEdit = true
      },
      edit (data) {
        this.modalTit = this.$t('relation.modalTit2');
        this.$refs['formValidate'].resetFields();
      ...
      remove (data) {
        ...
        _vm.$Modal.confirm({
          ...
          content: `<p>${_vm.$t('relation.msg1')}</p>
          <p>${_vm.$t('relation.msg2')}</p>
