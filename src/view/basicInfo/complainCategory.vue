...
<template>
  <div class="container-box">
    <div class="container-header">
      <h2>{{$t('layoutNav.complainCategoryManage')}}</h2>
...
<script>
  export default {
    ...
    methods: {
      getList () {
        ...
        _vm.$http.getPage({
          ...
          success: function(res){
            ...
            if(_vm.langRouterKey !== 'complainCategory') {
              _vm.data = _data;
            } else {
      ...
      add () {
        this.modalTit = this.$t('complainCategory.modalTit1');
        this.$refs['formValidate'].resetFields();
        this.seen = false;
        this.modalEdit = true;
      },
      edit (data) {
        this.modalTit = this.$t('complainCategory.modalTit2');
        this.$refs['formValidate'].resetFields();
      ...
      remove (data) {
        ...
        _vm.$Modal.confirm({
          ...
          content: `<p>${_vm.$t('complainCategory.msg1')}</p>
          <p>${_vm.$t('complainCategory.msg2')}</p>
