      ...
      <Form :label-width="90" ref="formSearch" :model="formSearch">
        <Row type="flex" justify="start">
          <Col :xs='24' :sm='12' :md="8" :lg="6">
            <Form-item label="操作时间" prop='startTime'>
          ...
          <Col :xs='24' :sm='12' :md="8" :lg="6">
            <Form-item label="渠道商" prop='distributionUserId'>
              <input-remote
                :list='parentList' 
  ...
  export default {
    ...
    methods: {
      ...
      getList(pageNumber, form) {
        ...
        _vm.$http.getPage({
          url: 'guard-webManager/distributionUserRecharge/findDistributionUserLevelRecord.jhtml',
          data: form,
          success: function(res){
            const data = res.data.content.content || [];
            const _col = _vm.tableCount(data, ['amount', 'virtualCurrencyBalance']);
            _col.map(item => {
