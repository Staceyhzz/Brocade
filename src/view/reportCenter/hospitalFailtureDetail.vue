        ...
        <div class="container-body">
            ...
            <Form :label-width="80" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="提交用户" prop='createUserId'>
                    <cmptDeptChooseUser _placeHolder="选择用户" :_style="{width:'162px'}" :_userName="createUserName" v-on:setUserName="setCreateUser"></cmptDeptChooseUser>
                </Form-item>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalFailtureDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalFailtureDetail.jhtml',
                    data: form,
