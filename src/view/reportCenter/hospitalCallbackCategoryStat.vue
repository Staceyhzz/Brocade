...
<script>
    export default {
        ...
        computed: {
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalCallbackCategoryStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalCallbackCategoryStat.jhtml',
                    data: form,
