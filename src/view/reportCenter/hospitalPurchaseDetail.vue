    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            <form :action="exportPrefixURL" method="get" ref="formSubmit" v-show="show">
                ...
                <input name="supplierId" :value="formSearch.supplierId">
            ...
            <Form :label-width="80" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="采购单号" prop='no'>
                    <Input type="text" :maxlength='15' v-model.trim="formSearch.no" placeholder="请输入采购单号" @on-enter="getList(1, formSearch)"></Input>
                </Form-item>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalPurchaseDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalPurchaseDetail.jhtml',
                    data: form,
