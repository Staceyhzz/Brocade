...
<script>
    export default {
            ...
            return {
                ...
                col: [
                    ...
                    },
                    {
                        ...
                        key: 'debt',
                        render: (h, params) => {
                            let text = params.row.debt.toFixed(2)
                            return h('span', text)
                        }
                    },
                    {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalRepaymentDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalRepaymentDetail.jhtml',
                    data: form,
