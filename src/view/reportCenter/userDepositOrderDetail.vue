        ...
        <div class="container-body">
            ...
            <Form :label-width="80" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="客户编号" prop='customerId'>
                    <Input type="text" v-model.trim="formSearch.customerId" placeholder="请输入客户编号"></Input>
                </Form-item>
...
<script>
    export default {
            ...
            return {
                ...
                col: [
                    ...
                    },
                    {
                    	...
                    	key: 'paidStatus',
                    	render: (h, params) => {
                    		let text = params.row.paidStatus == 2 ? '完成付款':'未支付'
                    		return h('span', text)
                    	}
                    },
                    {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/userDepositOrderDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/userDepositOrderDetail.jhtml',
                    data: form,
