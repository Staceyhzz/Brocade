    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <Form :label-width="60" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="投诉医院" prop='hospitalId'>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/complainDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/complainDetail.jhtml',
                    data: form,
