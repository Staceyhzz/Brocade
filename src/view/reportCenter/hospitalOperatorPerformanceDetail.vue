<!-- hospitalOperatorPerformanceDetail -->
<!-- 医院医生业绩明细 -->
/**
* 医院医生业绩明细
*/
  ...
  export default {
    ...
    computed: {
      ...
      exportPrefixURL() {
        return this.$store.getters.getExportPrefixURL +
          '/guard-webManager/excelExport/hospitalOperatorPerformanceDetail.jhtml'
      }
    },
    components: {
      cmptChargeChoose
    ...
    methods: {
      getList(pageNumber, form) {
        ...
        _vm.$http.get({
          url: 'guard-webManager/report/hospitalOperatorPerformanceDetail.jhtml',
          data: form,
