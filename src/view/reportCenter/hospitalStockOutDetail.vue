    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <Form :label-width="60" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="出库仓库" prop='warehouseId'>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalStockOutDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalStockOutDetail.jhtml',
                    data: form,
