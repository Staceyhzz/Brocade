<!-- depositOrderDetailHospitalDateStat -->
<!-- 集团预收款单各医院每日统计 -->
/**
 * 集团预收款单各医院每日统计
 */
...
<script>
    export default {
        ...
        computed: {
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/depositOrderDetailHospitalDateStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/depositOrderDetailHospitalDateStat.jhtml',
                    data: form,
