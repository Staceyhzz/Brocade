...
<template>
    <div class="container-box CCDS" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <table class="CCDS-table tableEdit">
            	<thead>
            		<tr class="table-item">
            			<th>日期</th>
            			<th>收款方式</th>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/cashCardDateStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/cashCardDateStat.jhtml',
                    data: form,
...
<style type="text/css" scoped>
    ...
    #app .tableEdit.CCDS-table td,#app .tableEdit.CCDS-table th{
