<!-- hospitalDoctorOrderDetailDetail -->
<!-- 医院所有医生指定项目明细 -->
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalDoctorOrderDetailDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalDoctorOrderDetailDetail.jhtml',
                    data: form,
