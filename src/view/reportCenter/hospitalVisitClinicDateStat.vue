...
<script>
    export default {
        ...
        computed: {
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalVisitClinicDateStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalVisitClinicDateStat.jhtml',
                    data: form,
