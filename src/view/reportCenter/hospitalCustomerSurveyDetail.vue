...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalCustomerSurveyDetail.jhtml'
            }
        },
        created () {
        	this.getSurveyList()
        ...
        methods: {
            ...
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalCustomerSurveyDetail.jhtml',
                    data: form,
                    success: function(res){
                        if(res.data.code == 0) {
