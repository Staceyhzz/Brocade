        ...
        <div class="container-body">
            ...
            <Form :label-width="100" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="咨询人员" prop='managerUserId'>
                    <cmptHospChooseUser _placeHolder="请选择用户" :_style="{width:'162px'}" :_userName="managerUserName" v-on:setUserName="setManagerUser"></cmptHospChooseUser>
                </Form-item>
                <Form-item label="开发人员" prop='exploitUserId'>
                    <cmptHospChooseUser _placeHolder="请选择用户" :_style="{width:'162px'}" :_userName="exploitUserName" v-on:setUserName="setExploitUser"></cmptHospChooseUser>
                </Form-item>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/visitDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/visitDetail.jhtml',
                    data: form,
