    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <Form :label-width="85" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="执行医院" prop='hospitalId'>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/operationDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/operationDetail.jhtml',
                    data: form,
