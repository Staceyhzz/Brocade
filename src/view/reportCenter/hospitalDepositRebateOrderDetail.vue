<!-- hospitalDepositRebateOrderDetail -->
<!-- 医院退预收款明细 -->
/**
 * 医院退预收款明细
 */
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalDepositRebateOrderDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalDepositRebateOrderDetail.jhtml',
                    data: form,
