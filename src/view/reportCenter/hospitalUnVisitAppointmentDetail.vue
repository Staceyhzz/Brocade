<!-- hospitalUnVisitAppointmentDetail -->
<!-- 医院未上门咨询预约 -->
/**
 * 医院未上门咨询预约
 */
...
<script>
    export default {
            ...
            return {
                ...
                col: [
                    ...
                    },
                    {
                        title: '预约时间',
                        render: (h, params) => {
	                        const _start = params.row.appointmentStartTime.split(' ')[1] || ''
                            const _end = params.row.appointmentEndTime.split(' ')[1] || ''
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalUnVisitAppointmentDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalUnVisitAppointmentDetail.jhtml',
                    data: form,
