    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <Form inline :model="formSearch" ref='formSearch'>
                <Form-item :label-width="40" label="医院" prop='hospitalId'>
                ...
                <Form-item :label-width='1' prop='restDeposit'>
                    <Input type="text" :maxlength='15' v-model.trim="formSearch.restDeposit" placeholder="输入金额" @on-enter="getList(1, formSearch)"></Input>
                </Form-item>
                ...
                <Form-item :label-width='1' prop='deposit'>
                    <Input type="text" :maxlength='15' v-model.trim="formSearch.deposit" placeholder="输入金额" @on-enter="getList(1, formSearch)"></Input>
                </Form-item>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/customerDepositDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/customerDepositDetail.jhtml',
                    data: form,
