...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/userCreateAppointmentDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/userCreateAppointmentDetail.jhtml',
                    data: form,
