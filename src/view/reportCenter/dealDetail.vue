  ...
  <div class="container-box" ref="containerBox">
    ...
    <div class="container-body">
      ...
      <Form :label-width="85" inline :model="formSearch" ref='formSearch'>
        ...
        <Form-item label="到诊医院" prop='hospitalId'>
        ...
        <Form-item label="开单人员" prop='createUserId'>
          <cmptHospChooseUser _placeHolder="请选择用户" :_style="{width:'162px'}" :_userName="createUserName"
            v-on:setUserName="setCreateUser"></cmptHospChooseUser>
        </Form-item>
        <Form-item label="主诊医生" prop='doctorUserId'>
          <cmptHospChooseUser _placeHolder="请选择用户" :_style="{width:'162px'}" :_userName="doctorUserName"
            v-on:setUserName="setDoctorUser"></cmptHospChooseUser>
        </Form-item>
...
<script>
  export default {
    ...
    computed: {
      ...
      exportPrefixURL() {
        return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/dealDetail.jhtml'
      }
    },
    created() {
    ...
    methods: {
      getList(pageNumber, form) {
        ...
        _vm.$http.get({
          url: 'guard-webManager/report/dealDetail.jhtml',
          data: form,
