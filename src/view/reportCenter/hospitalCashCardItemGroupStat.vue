...
<template>
    <div class="container-box hospCCIGS" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <table class="hospCCIGS-table tableEdit">
            	<thead>
            		<tr class="table-item">
            			<th>营收项目</th>
            			<th>收款方式</th>
...
<script>
    export default {
        ...
        computed: {
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalCashCardItemGroupStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalCashCardItemGroupStat.jhtml',
                    data: form,
...
<style type="text/css" scoped>
	.hospCCIGS .hospCCIGS-table {
		width: 100%
	}
	.hospCCIGS .hospCCIGS-table thead tr{
		border-right: 1px solid #d7dde4;
	}
	.hospCCIGS .hospCCIGS-table tr {
    ...
    #app .tableEdit.hospCCIGS-table td,#app .tableEdit.hospCCIGS-table th{
