...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalCallbackDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            ...
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalCallbackDetail.jhtml',
                    data: form,
                    success: function(res){
                        if(res.data.code == 0) {
