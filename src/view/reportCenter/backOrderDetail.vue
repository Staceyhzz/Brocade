    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            <form :action="exportPrefixURL" method="get" ref="formSubmit" v-show="show">
                ...
                <input name="status" :value="formSearch.createUserId">
                <input name="status" :value="formSearch.customerId">
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/backOrderDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/backOrderDetail.jhtml',
                    data: form,
