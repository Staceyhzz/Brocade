<!-- depositOrderDetailHospitalStat -->
<!-- 集团预收款单各医院统计 -->
/**
 * 集团预收款单各医院统计
 */
...
<script>
    export default {
        ...
        computed: {
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/depositOrderDetailHospitalStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/depositOrderDetailHospitalStat.jhtml',
                    data: form,
