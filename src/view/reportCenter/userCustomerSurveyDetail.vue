    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            <form :action="exportPrefixURL" method="get" ref="formSubmit" v-show="show">
                ...
                <input name="targetUserId" :value="formSearch.surveyId">
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/userCustomerSurveyDetail.jhtml'
            }
        },
        created () {
        	this.getSurveyList()
        ...
        methods: {
            ...
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/userCustomerSurveyDetail.jhtml',
                    data: form,
                    success: function(res){
                        if(res.data.code == 0) {
