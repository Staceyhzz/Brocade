<!-- hospitalDepositOrderDetailDetail -->
<!-- 医院预收款项目明细 -->
/**
 * 医院预收款项目明细
 */
        ...
        <div class="container-body">
            ...
            <Form :label-width="80" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="客户编号" prop='customerId'>
                    <Input type="text" v-model.trim="formSearch.customerId" placeholder="请输入客户编号" @on-enter="getList(1, formSearch)"></Input>
                </Form-item>
...
<script>
    export default {
            ...
            return {
                ...
                col: [
                    ...
                    },
                    {
                        title: '日期',
                        render: (h, params) => {
                            const _text = moment(params.row.paidTime).format('YYYY-MM-DD')
                            return h('span', _text)
                        }
                    },
                    {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalDepositOrderDetailDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalDepositOrderDetailDetail.jhtml',
                    data: form,
