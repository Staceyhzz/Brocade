    ...
    <div class="container-box">
        <div class="container-body">
            ...
            <Form :label-width="60" inline :model="formSearch" ref='formSearch'>
                ...
                <Form-item label="渠道商" prop='storeID' v-if='hospKey'>
                    <cmptRemoteFilterStore :_type='3' _placeHolder="选择渠道商" @setStoreName="setStoreName" ref='remoteStore'></cmptRemoteFilterStore>
                </Form-item>
                <Form-item label="渠道商" prop='storeID' v-else>
                    <cmptRemoteFilterStore _placeHolder="选择渠道商" @setStoreName="setStoreName" ref='remoteStore'></cmptRemoteFilterStore>
                </Form-item>
...
<script>       
    export default {
        data () {
            return {
                menuRouteUrl: '/commissionDetailStore',
                hospKey: true,
                show: false,
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/storeCommissionStoreCalculate.jhtml'
            }
        },
        created () {
        ...
        methods: {
            ...
            getList() {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/storeCommissionStoreCalculate.jhtml',
                    data: _vm.formSearch,
