  ...
  export default {
    ...
    computed: {
      ...
      exportPrefixURL() {
        return this.$store.getters.getExportPrefixURL +
          '/guard-webManager/excelExport/userOperatorPerformanceDetail.jhtml'
      }
    },
    components: {
      cmptChargeChoose
    ...
    methods: {
      getList(pageNumber, form) {
        ...
        _vm.$http.get({
          url: 'guard-webManager/report/userOperatorPerformanceDetail.jhtml',
          data: form,
