<!-- managerUserDealDetail -->
<!-- exploitUserDealDetail -->
<!-- 咨询人员成交明细表 (个人)-->
/**
* 咨询人员成交明细表 (个人)
*/
    ...
    <div class="container-body">
      ...
      <Form :label-width="85" inline :model="formSearch" ref='formSearch'>
        ...
        <Form-item label="客户编号" prop='customerId'>
          <Input type="text" :maxlength='15' @on-enter="getList(1, formSearch)" v-model.trim="formSearch.customerId"
            placeholder="请输入客户编号"></Input>
        </Form-item>
        <Form-item label="客户名称" prop='customerName'>
          <Input type="text" :maxlength='15' @on-enter="getList(1, formSearch)" v-model.trim="formSearch.customerName"
...
<script>
  export default {
    ...
    computed: {
      ...
      exportPrefixURL() {
        return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/managerUserDealDetail.jhtml'
      }
    },
    created() {
    ...
    methods: {
      getList(pageNumber, form) {
        ...
        _vm.$http.get({
          url: 'guard-webManager/report/managerUserDealDetail.jhtml',
          data: form,
