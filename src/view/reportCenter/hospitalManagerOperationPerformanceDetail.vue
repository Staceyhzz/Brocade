  ...
  export default {
    ...
    computed: {
      ...
      exportPrefixURL() {
        return this.$store.getters.getExportPrefixURL +
          '/guard-webManager/excelExport/hospitalManagerOperationPerformanceDetail.jhtml'
      }
    },
    components: {
      cmptChargeChoose
    ...
    methods: {
      getList(pageNumber, form) {
        ...
        _vm.$http.get({
          url: 'guard-webManager/report/hospitalManagerOperationPerformanceDetail.jhtml',
          data: form,
