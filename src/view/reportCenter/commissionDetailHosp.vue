...
<script>
    export default {
        data () {
            return {
                menuRouteUrl: '/commissionDetailHosp',
                hospKey: true,
                show: false,
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/storeCommissionHospitalCalculate.jhtml'
            }
        },
        created () {
        ...
        methods: {
            ...
            getList() {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/storeCommissionHospitalCalculate.jhtml',
                    data: _vm.formSearch,
                    success: function(res){
                        if(res.data.code == 0) {
                            _vm.data = res.data.content.list || []
                            let _obj = {}
                            _obj.hospitalName = '合计'
