    ...
    <div class="container-box" ref="containerBox">
        ...
        <div class="container-body">
            <form :action="exportPrefixURL" method="get" ref="formSubmit" v-show="show">
                ...
                <input name="deptId" :value="formSearch.customerId">
                <input name="tool" :value="formSearch.createUserId">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/consultDetail.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(pageNumber, form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/consultDetail.jhtml',
                    data: form,
