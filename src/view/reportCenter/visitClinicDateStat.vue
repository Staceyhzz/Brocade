...
<script>
    export default {
            ...
            return {
                ...
                col: [
                    ...
                    },
                    {
                        ...
                        key: 'dealPercent',
                        render: (h, params) => {
                            if(params.row.dealPercent || params.row.dealPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'newPercent',
                        render: (h, params) => {
                            if(params.row.newPercent || params.row.newPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'newDealPercent',
                        render: (h, params) => {
                            if(params.row.newDealPercent || params.row.newDealPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'oldPercent',
                        render: (h, params) => {
                            if(params.row.oldPercent || params.row.oldPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'oldDealPercent',
                        render: (h, params) => {
                            if(params.row.oldDealPercent || params.row.oldDealPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'firstPercent',
                        render: (h, params) => {
                            if(params.row.firstPercent || params.row.firstPercent == 0) {
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            if(params.row.firstDealPercent || params.row.firstDealPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'twicePercent',
                        render: (h, params) => {
                            if(params.row.twicePercent || params.row.twicePercent == 0) {
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            if(params.row.twiceDealPercent || params.row.twiceDealPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'againPercent',
                        render: (h, params) => {
                            if(params.row.againPercent || params.row.againPercent == 0) {
                    ...
                    },
                    {
                        ...
                        key: 'checkPercent',
                        render: (h, params) => {
                            if(params.row.checkPercent || params.row.checkPercent == 0) {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/visitClinicDateStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/visitClinicDateStat.jhtml',
                    data: form,
