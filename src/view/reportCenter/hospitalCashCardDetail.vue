...
<script>
  export default {
      ...
      return {
        ...
        col: [{
          ...
          },
          {
            ...
            key: 'inOutType',
            render: (h, params) => {
              let text = params.row.inOutType === 1 ? '入' : '出'
              return h('span', text)
            }
          },
          {
    ...
    computed: {
      ...
      exportPrefixURL() {
        return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalCashCardDetail.jhtml'
      }
    },
    created() {
    ...
    methods: {
      getList(pageNumber, form) {
        ...
        _vm.$http.get({
          url: 'guard-webManager/report/hospitalCashCardDetail.jhtml',
          data: form,
