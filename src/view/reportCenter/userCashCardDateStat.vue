...
<template>
    <div class="container-box userCCDS" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <table class="userCCDS-table tableEdit">
            	<thead>
            		<tr class="table-item">
            			<th>日期</th>
            			<th>收款方式</th>
...
<script>
    export default {
        ...
        computed: {
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/userCashCardDateStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/userCashCardDateStat.jhtml',
                    data: form,
...
<style type="text/css" scoped>
	.userCCDS .userCCDS-table {
		width: 100%
	}
	.userCCDS .userCCDS-table thead tr{
		border-right: 1px solid #d7dde4;
	}
	.userCCDS .userCCDS-table tr {
    ...
    #app .tableEdit.userCCDS-table td,#app .tableEdit.userCCDS-table th{
