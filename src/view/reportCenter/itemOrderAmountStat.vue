...
<template>
    <div class="container-box IAS" ref="containerBox">
        ...
        <div class="container-body">
            ...
            <table class="IAS-table tableEdit">
            	<thead>
            		<tr class="table-item">
            			<th>意向分类</th>
            			<th>消费意向</th>
...
<script>
    export default {
        ...
        computed: {
            ...
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/itemOrderAmountStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/itemOrderAmountStat.jhtml',
                    data: form,
...
<style type="text/css" scoped>
    ...
    #app .tableEdit.IAS-table td,#app .tableEdit.IAS-table th{
