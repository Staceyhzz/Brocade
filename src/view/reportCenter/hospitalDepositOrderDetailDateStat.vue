<!-- hospitalDepositOrderDetailDateStat -->
<!-- 医院预收款单每日统计 -->
/**
 * 医院预收款单每日统计
 */
...
<script>
    export default {
        ...
        computed: {
            exportPrefixURL () {
                return this.$store.getters.getExportPrefixURL + '/guard-webManager/excelExport/hospitalDepositOrderDetailDateStat.jhtml'
            }
        },
        created () {
        ...
        methods: {
            getList(form) {
                ...
                _vm.$http.get({
                    url: 'guard-webManager/report/hospitalDepositOrderDetailDateStat.jhtml',
                    data: form,
