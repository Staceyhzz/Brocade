...
<template>
  <div class="container-box product-category">
    <div class="container-header">
      <h2>{{$t('layoutNav.productCategoryManage')}}</h2>
    ...
    <div class="container-body">
      ...
      <Modal
        :title="$t('productCategory.modalTit3')"
        width='700'
        v-model="modal1"
        :closable="false"
...
<script>
  export default {
    ...
    methods: {
      getList () {
        ...
        _vm.$http.getPage({
          ...
          success: function(res){
            ...
            if(_vm.langRouterKey !== 'productCategory') {
      ...
      add () {
        this.modalTit = this.$t('productCategory.modalTit1');
      ...
      edit (data) {
        this.modalTit = this.$t('productCategory.modalTit2');
        this.$refs['formValidate'].resetFields();
      ...
      remove (data) {
        ...
        _vm.$Modal.confirm({
          ...
          content: `<p>${_vm.$t('productCategory.msg1')}</p>
          <p>${_vm.$t('productCategory.msg2')}</p>
