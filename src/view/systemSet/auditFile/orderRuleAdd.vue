  ...
  <div class="container-box order-rule-add">
    ...
    <div class="container-body">
      <Form ref="formAdd" :model='formAdd' :label-width="100" label-position="right" :rules="ruleForm">
        ...
        <Form-item :label="$t('auditRule.label10')" prop="discount">
          <cmptInputNumber :max="100" :min="0" v-model="formAdd.discount" style="width:300px"></cmptInputNumber>
        </Form-item>
      ...
      save() {
        ...
        _vm.$refs['formAdd'].validate((valid) => {
          if (valid) {
            ...
            _vm.$http.post({
              url: 'guard-webManager/auditRule/orderRuleAddEdit.jhtml',
              data: _vm.formAdd,
