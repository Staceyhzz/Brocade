  ...
  <div class="container-box order-rule-add">
    ...
    <div class="container-body">
      <Form ref="formAdd" :model='formAdd' :label-width="100" label-position="right" :rules="ruleForm">
        ...
        <Form-item :label="$t('auditRule.label11')" prop="amount" required>
          <cmptInputNumber :min="0" :max='1000000' v-model="formAdd.amount" style="width:300px" @on-change='setAmount'></cmptInputNumber>
        </Form-item>
      ...
      save() {
        ...
        _vm.$refs['formAdd'].validate((valid) => {
          if (valid) {
            ...
            _vm.$http.post({
              url: 'guard-webManager/auditRule/rebateDepositRuleAddEdit.jhtml',
              data: _vm.formAdd,
