...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      aaa(aa) {
        console.log(this.sde.getControlById(aa));
        return this.sde.getControlById(aa).getOpt();

      },
      bbb(bb) {
        return this.sde.getControlById(bb).TYPE_NAME;
      },
      ccc(cc) {
         return this.sde.getControlById();
      },
      initEditor() {
